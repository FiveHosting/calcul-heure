...
monthPicker.style.opacity = '0.001';
monthPicker.style.position = 'fixed';
monthPicker.style.left = '0';
monthPicker.style.top = '0';
monthPicker.style.width = '100vw';
monthPicker.style.height = '100vh';
...
monthPicker.style.left = '';
monthPicker.style.top = '';
monthPicker.style.width = '1px';
monthPicker.style.height = '1px';
monthPicker.style.zIndex = '';
}, 500);
});
}
